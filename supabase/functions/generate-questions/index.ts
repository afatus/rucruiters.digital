...
+          `Bu pozisyonda kullanacağınız teknolojiler ve araçlar konusunda detay verebilir misiniz?`,
...
+          `${jobTitle} pozisyonu ve şirketimiz hakkında sizi en çok ne heyecanlandırıyor?`,
...
+          `${jobTitle} alanında karmaşık problemleri çözerken hangi yaklaşımları kullanıyorsunuz?`,
+          `Bu sektördeki güncel trendleri nasıl takip ediyorsunuz?`,
