/*
  # Son Mülakatlar RLS Sorununu Çöz

  1. Mevcut Durumu Kontrol Et
    - get_current_tenant_id() fonksiyonunu kontrol et
    - interviews tablosu RLS politikalarını düzelt
    - it_admin rolü için tam erişim sağla

  2. Güvenlik
    - it_admin ve super_admin rolleri tüm mülakatları görebilir
    - Diğer roller sadece kendi tenant'larındaki mülakatları görebilir
*/
