/*
  ...
  1. New Tables
    - `profiles` table for user roles and profile information
    - Supports roles: recruiter, hiring_manager, line_manager, candidate, hr_operations, it_admin

  2. Enhanced Tables
    - `jobs` table: Added hiring_manager_id and line_manager_id columns
    - `ai_analysis` table: Added manager feedback columns

  3. Security
    - Enable RLS on profiles table
    - Update all existing policies for role-based access
